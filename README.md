...
### Deep Learning
As we need to do a pixel wise classification we needed to use a model with an architecture like U-Net and we actually tried it and got a score of ... which made us eager to find a better solution with a higher score.
